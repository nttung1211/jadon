    ...
    <div class="col-12 mx-auto mt-4">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-lg-6 order-lg-0 order-1">
            ...
            <div class="form-group mt-3">
              ...
              <input type="date" name="event_date" id="event_date" class="form-control" value="<?php echo htmlspecialchars($_POST['event_date'] ?? ''); ?>">
            </div>
        ...
        <div class="form-group">
          ...
          <textarea type="text" name="description" id="content" class="form-control"><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
        </div>
